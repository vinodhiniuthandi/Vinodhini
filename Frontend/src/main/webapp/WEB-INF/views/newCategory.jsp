...
<div class="container">
    ...
    <input type="text" placeholder="Enter Category Id" name="id"  id="categoryId" required>

 <label><b>Category Name</b></label>
    <input type="text" placeholder="Enter Category Name" name="name"  id="categoryName" required>
 <label><b>Category Description</b></label>
    <input type="text" placeholder="Enter Category Description" name="description"  id="description" required>

...
<br><br>
		<div class="container-fluid">
			...
			<div class="navbar-header"><div class="navbar-header-top-right">
		<span class=" glyphicon glyphicon-fa fa-facebook-square">
		<span class=" glyphicon glyphicon-fa fa-twitter-square">
		</div>
        ...
        <li><a href="#"><span class="glyphicon glyphicon-search"></span></a></li>
					...
					<li><a href="login.jsp"><span class="glyphicon glyphicon-log-in"></span>
							Login</a></li>
					<li><a href="register.jsp"><span class="glyphicon glyphicon-share">SignUp</span></li>
				</ul>
			</div>
